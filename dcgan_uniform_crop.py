...
#            d_loss = 0.5 * np.add(d_loss_fake, d_loss_real)
            ...
            idx_x = np.random.randint(0,15)
            idx_y = np.random.randint(0,39)            
            ...
            if epoch % 5000 == 0 :
                ...
                self.generator.save_weights('./dcgan_model2/generator{}.hdf5'.format(ep))
                self.discriminator.save_weights('./dcgan_model2/discriminator{}.hdf5'.format(ep))
